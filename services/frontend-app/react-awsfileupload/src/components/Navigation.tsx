...
<nav className="">
  <div className="container mx-auto px-4 md:flex items-center gap-6">
    ...
    <div className="flex items-center justify-between md:w-auto w-full">
      <a href="/" className="py-5 px-2 flex-1 font-bold">AWS S3 Repository</a>
      {/* mobile menu icon */}
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
        ...
        <div className="dropdown-menu absolute hidden bg-secondarybg text-secondarytext rounded-b-lg pb-2 w-40 z-50" id="selectOptions">
          <a href="#" className="nav-dropdownitem">Some other page</a>
          <a href="#" className="nav-dropdownitem">Another page</a>
          <a href="#" className="nav-dropdownitem">Work in progress</a>
          <a href="#" className="nav-dropdownitem">To be continued</a>
        </div>
      </div>
    </div>
  </div>
